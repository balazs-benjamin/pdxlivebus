...
leafletDirective.directive("leaflet", ["$http", "$log", "$timeout", function ($http, $log, $timeout) {
    ...
    return {
        ...
        link: function ($scope, element, attrs /*, ctrl */) {
            ...
            var map = new L.Map(element[0], {zoomControl: $scope.leaflet.mapOptions.zoomControl, fadeAnimation: false});
            map.setView([0, 0], 1);
            ...
            function setupCenter() {
                ...
                map.on('zoomstart', function()
                {
                    ...
                    angular.element(document.querySelectorAll('.leaflet-marker-icon')).addClass('notransition');
                    $timeout(function(){
                        angular.element(document.querySelectorAll('.leaflet-marker-icon')).removeClass('notransition');
                    },100)
                })
